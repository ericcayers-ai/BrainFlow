...
export const APP_COMMANDS: AppCommand[] = [
  ...
  {
    id: "view.workflow",
    title: "Focus Workflow Suite",
    shortcut: "Ctrl+1",
    keywords: ["goal", "graph", "primary"],
  },
  {
    id: "view.notes",
    title: "Focus notes & vault",
    shortcut: "Ctrl+2",
    keywords: ["editor", "files"],
  },
  {
    id: "view.tools",
    title: "Focus studio tools",
    shortcut: "Ctrl+3",
    keywords: ["models", "sync", "settings"],
  },
  {
    id: "view.wordCount",
