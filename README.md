...
> Status: **Unsigned Windows alpha** — Phase 1 sizes+startup recorded — scripted vertical-slice E2E green — see [docs/REMAINING_GAPS.md](docs/REMAINING_GAPS.md). **Not GA.** Installers are not code-signed; macOS/Linux packaging is not verified.
